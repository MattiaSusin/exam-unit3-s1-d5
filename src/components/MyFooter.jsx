      ...
      <Container>
        ...
        <Row>
          <Col xs={6} md={3}>
            ...
            <p id="pFooter">Media Center</p>
            <p id="pFooter">Privacy</p>
            <p id="pFooter">Contact Us</p>
          </Col>
          <Col xs={6} md={3}>
            <p id="pFooter">Audio Description</p>
            <p id="pFooter">Investor Relations</p>
            <p id="pFooter">Legal Notices</p>
          </Col>
          <Col xs={6} md={3}>
            <p id="pFooter">Help Center</p>
            <p id="pFooter">Jobs</p>
            <p id="pFooter">Cookie Preferences</p>
          </Col>
          <Col xs={6} md={3}>
            <p id="pFooter">Gift Cards</p>
            <p id="pFooter">Terms of Use</p>
